...
\begin{itemize}
    ...
    \begin{figure}[htbp]
    \centering
    \subfigure[Motor DC real \cite{noauthor_775-9009f-c-cc_nodate}]{\includegraphics[width=40mm]{pictures/DcMotor.jpeg}}
    \subfigure[Funcionamiento \cite{noauthor_motor_2020}]{\includegraphics[width=40mm]{pictures/Motor DC Magnetic.png}}
    ...
    \begin{figure}[H]
    \centering
    \subfigure[Motor real \cite{banggoodcom_3pcs_nodate}]{\includegraphics[width=56mm]{pictures/PasoPasoMotor.jpg}}
    \subfigure[Funcionamiento \cite{noauthor_stepper_nodate}]{\includegraphics[width=56mm]{pictures/MotorPasoPasoMagnetic.png}}
    ...
    \begin{figure}[H]
    \centering
    \subfigure[Servomotor real \cite{noauthor_mini_nodate}]{\includegraphics[width=50mm]{pictures/Servo.jpg}}
    \subfigure[Funcionamiento \cite{noauthor_how_2019}]{\includegraphics[width=80mm]{pictures/Servo-Motor-Internal-Structure-Illustration.png}}
