En este apartado se describe que tipo de motores se han utilizado, así como las razones que han llevado a utilizar un tipo de motores en lugar de otros.
...
\begin{itemize}
    ...
    \begin{figure}[htbp]
    \centering
    \subfigure[Motor DC real]{\includegraphics[width=40mm]{pictures/DcMotor.jpeg}}
    \subfigure[Funcionamiento]{\includegraphics[width=40mm]{pictures/Motor DC Magnetic.png}}
    ...
    \begin{figure}[H]
    \centering
    \subfigure[Motor real]{\includegraphics[width=56mm]{pictures/PasoPasoMotor.jpg}}
    \subfigure[Funcionamiento]{\includegraphics[width=56mm]{pictures/MotorPasoPasoMagnetic.png}}
    ...
    \begin{figure}[H]
    \centering
    \subfigure[Servomotor real]{\includegraphics[width=50mm]{pictures/Servo.jpg}}
    \subfigure[Funcionamiento]{\includegraphics[width=80mm]{pictures/Servo-Motor-Internal-Structure-Illustration.png}}
