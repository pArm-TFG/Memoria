...
% DAFAK IS THE REPETICION OF "QUE RECIBE UNA TENSION" IHUEPUTA MAL PARIDO
...
\begin{itemize}
    ...
    \begin{figure}[H]
    \centering
    \subfigure[Icono de impresión de placas \cite{7759009FCCCDatasheetHoja}]{\includegraphics[width=80mm]{pictures/Imprimir\ac{PCB}.PNG}}
    \subfigure[Desplegable de la herramienta
    \cite{MotorCorrienteContinua2020}]{\includegraphics[width=80mm]{pictures/Imprimir\ac{PCB}2.PNG}}
   ...
   Para imprimir dichas máscaras en papel de transparencia, primeramente se imprimen en papel convencional y posteriormente se fotocopian a un papel de transparencia, obteniendo el resultado siguiente:
    ...
    \subfigure[Aclarado de la \ac{PCB}
   ...
   \begin{figure}[H]
    ...
    \subfigure[\ac{PCB} siendo sometida al proceso de atacado
    ...
    \subfigure[Parte trasera de la \ac{PCB}
   ...
   \item En sexto lugar se debe realizar taladrado de los orificios de la \ac{PCB} y el guillotinado de los márgenes de la misma.
