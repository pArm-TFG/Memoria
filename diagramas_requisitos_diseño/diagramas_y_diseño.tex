...
\begin{itemize}
    ...
    \item \texttt{saveActualTicks}: Se guardan los ticks actuales que el motor ha recorrido. Los ticks representan ciclos de instrucción durante los cuales el motor recibe una señal PWM especifica. Se entra en detalle sobre este aspecto en apartados posteriores del documento.
