...
``\textit{Space Station Remote Manipulator System}'' (SSRMS) (ver figura \ref{fig:canadarm2}).

\begin{figure}[H]
    \centering
    \includegraphics[width=.75\linewidth]{pictures/STS-114_Steve_Robinson_on_Canadarm2.jpg}
