...
ambos ``\textit{rockers}'' (ver figura \ref{fig:rb-system}).

\begin{figure}[H]
    \centering
    \includegraphics[width=.6\linewidth]{pictures/rocker-bogie.png}
    \caption{Modo de funcionamiento del sistema ``\textit{rocker--bogie}'', 
    desarrollado por la NASA para sus rover \cite{Rockerbogie2020}.}
    \label{fig:rb-system}
\end{figure}
...
Los avances en esta industria permiten el control mecanizado completo del vehículo, tomando
...
o el brazo ``M-2000'', de FANUC hasta brazos más pequeños con motivos educacionales, como
