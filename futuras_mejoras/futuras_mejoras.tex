...
\begin{itemize}
    ...
    El modelo dinámico del robot establece las relaciones matemáticas entre el movimiento del manipulador y las fuerzas que afectan al mismo. En este modelo, se contemplan aspectos como la relación existente entre  las coordenadas articulares de las articulaciones y pares aplicados en ellas, con respecto a las coordenadas cartesianas, velocidad y aceleración del \textit{end--effector}, así como algunos parámetros de la estructura del brazo robótico, como la masa de los diferente segmentos, inercias y demás.
